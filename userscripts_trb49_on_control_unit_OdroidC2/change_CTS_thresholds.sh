...
# Take the content of the config.conf file into this shell environment: access the configurations file with THRS_CH9 and THRS_CH10 parameters (the file is the same directory as the present script)
. config.conf
