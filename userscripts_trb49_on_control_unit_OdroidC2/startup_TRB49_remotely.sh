...
$DIRBINtrbcmd/trbcmd w $FPGA 0xa017 0x30000      #Trigger Enable ch31-00   JM: Hardware channels 16 and 17
$DIRBINtrbcmd/trbcmd w $FPGA 0xa018 0x0	   #Trigger Enable ch47-32
$DIRBINtrbcmd/trbcmd w $FPGA 0xa01a 0x00000000  #Channel disable ch31-00, all channels except ch0
...
$DIRBINtrbcmd/trbcmd w $FPGA1 0xa017 0x30000      #Trigger Enable ch31-00  JM: Hardware channels 64 and 65
$DIRBINtrbcmd/trbcmd w $FPGA1 0xa018 0x0          #Trigger Enable ch47-32
$DIRBINtrbcmd/trbcmd w $FPGA1 0xa01a 0x00000000  #Channel disable ch31-00, all channels except ch0
...
#sh ./cts-dump.sh
#sh /home/odroid/trbsoft/userscripts/trb49/cts-dump-remotely.sh
